...
**Actuals so far (through 2026-08-28): $18.68 total OpenRouter spend** (the earlier "~$0.50" figure in this doc was wrong — checked against the live OpenRouter credits endpoint; ~$7.72 of credit remained) (classification $0.39, re-transcription lessons + testing the rest). Only paid service is OpenRouter; Supabase, Vercel, Archive.org, local whisper all $0.
